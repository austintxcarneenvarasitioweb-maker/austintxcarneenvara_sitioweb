...
export function CateringPackages({ packages }: CateringPackagesProps) {
  return (
    <section
          ...
          <StaggerItem key={pkg.id}>
            <article
              style={{
                ...
                height: '100%',
                border: `1px solid ${pkg.highlighted ? '#c84914' : '#3a1e10'}`,
                outline: pkg.highlighted ? '1px solid #c84914' : 'none',
                outlineOffset: pkg.highlighted ? '-1px' : undefined,
                marginLeft: pkg.highlighted ? '-1px' : undefined,
              }}
            >
              {pkg.highlighted && (
                <span
              ...
              <span
                style={{ fontSize: '11px', letterSpacing: '0.2em', textTransform: 'uppercase', color: 'rgba(237,224,204,0.6)', fontFamily: 'var(--font-body)', marginTop: 'auto' }}
              >
                Select →
              </span>
            </article>
